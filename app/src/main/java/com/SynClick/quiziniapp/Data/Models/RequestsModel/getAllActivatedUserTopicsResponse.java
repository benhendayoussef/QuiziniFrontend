...
public class getAllActivatedUserTopicsResponse {
    String message;
    List<Topic> userTopics;

    public getAllActivatedUserTopicsResponse() {
    }

    public getAllActivatedUserTopicsResponse(String message, List<Topic> topics) {
